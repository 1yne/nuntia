...
<main class="bg-gradient-to-b h-[100vh] from-purple to-complementary">
	<h1 class="font-bold text-6xl pt-10 mb-10 text-accent font-[Pacifico]" align="center">Nuntia</h1>
	<div align="center" class="w-[20rem] bg-white mx-auto h-[50vh] rounded-sm p-10 font-[Mali]">
